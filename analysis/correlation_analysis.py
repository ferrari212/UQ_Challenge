...
if __name__ == "__main__":
    ...
    fig.suptitle(f'Plot for all the timestamps across the samples, variation on the seed number', y=0.95, fontweight='bold')  # Adjust the y position of the title
